...
def get_sleep_time(delay:int=3) -> int:
    ...
    *Parameters*:
    - `delay` (int): Delay in seconds to be added. Defaults to 3 seconds
...
class Observer:
    ...
    *Methods*:
    - `__record(info) -> None`: Add information to the history.
